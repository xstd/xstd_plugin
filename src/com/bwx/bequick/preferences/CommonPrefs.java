...
//		findPreference(PREF_ABOUT_QUICKER).setOnPreferenceClickListener(this);
	...
	private Dialog createDialog(int titleId, int textId, boolean twoButtons) {
		Builder builder = new Builder(this).setIcon(R.drawable.ic_dialog_menu_generic).setTitle(titleId)
				.setMessage(textId);
		if (twoButtons) {
...
//			startActivity(browserIntent);
	...
	protected Dialog onCreateDialog(int id) {
		...
		if (id == 0) {
			Builder builder = new Builder(this).setIcon(R.drawable.ic_dialog_menu_generic).setTitle(
					R.string.pref_about);
